...
import io.github.alexzhirkevich.qrose.matrix.qr.internals.QRMath.gexp
import io.github.alexzhirkevich.qrose.matrix.qr.internals.QRMath.glog
...
internal class Polynomial(num: IntArray, shift: Int = 0) {
    ...
    init {
        val offset = num.indexOfFirst { it != 0 }
            .coerceAtLeast(0)
