...
const val AztecDefaultEcPrecent: Int = 33
const val AztecDefaultLayers: Int = 0
...
internal class AztecEncoder(
    private val minEccPercent: Int = AztecDefaultEcPrecent,
    private val userSpecifiedLayers: Int = AztecDefaultLayers
) : MatrixCodeEncoder {
    ...
    public override fun encode(
        ...
        if (userSpecifiedLayers != AztecDefaultLayers) {
