...
internal object QRUtil {
    ...
    fun getMaxLength(typeNumber: Int, dataType: QRCodeDataType, errorCorrectionLevel: QrErrorCorrection): Int =
     ...
     */
    fun getMask(maskPattern: QrMaskPattern, i: Int, j: Int): Boolean =
        when (maskPattern) {
