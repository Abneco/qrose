...
class DataMatrixEncoderTest {
    ...
    fun testSmallSquareDataMatrix() {
        val matrix = QroseEncoders.DataMatrix(DataMatrixShape.Square).encode("Test")
    ...
    fun testRectangularDataMatrix() {
        val matrix = QroseEncoders.DataMatrix(DataMatrixShape.Rectangle).encode("TEST1234")
    ...
    fun testDigitsDataMatrix() {
        val matrix = QroseEncoders.DataMatrix().encode("01234567890123456789")
    ...
    fun testLongTextMultiRegionDataMatrix() {
        ...
        val matrix = QroseEncoders.DataMatrix(DataMatrixShape.Square).encode(text)
